...
function jogada01() {
  if (quadrado2.style.backgroundColor == "yellow" || quadrado2.style.backgroundColor == "blue") {
    alert("Escolha outro quadrado!");
  }
...
function jogada02() {
  if (quadrado3.style.backgroundColor == "yellow" || quadrado3.style.backgroundColor == "blue") {
    alert("Escolha outro quadrado!");
  }
...
function jogada10() {
  if (quadrado4.style.backgroundColor == "yellow" || quadrado4.style.backgroundColor == "blue") {
    alert("Escolha outro quadrado!");
  }
...
function jogada11() {
  if (quadrado5.style.backgroundColor == "yellow" || quadrado5.style.backgroundColor == "blue") {
    alert("Escolha outro quadrado!");
  }
...
function jogada12() {
    if (quadrado6.style.backgroundColor == "yellow" || quadrado6.style.backgroundColor == "blue") {
      alert("Escolha outro quadrado!");
    }
  ...
  function jogada20() {
    if (quadrado7.style.backgroundColor == "yellow" || quadrado7.style.backgroundColor == "blue") {
      alert("Escolha outro quadrado!");
    }
  ...
  function jogada21() {
    if (quadrado8.style.backgroundColor == "yellow" || quadrado8.style.backgroundColor == "blue") {
      alert("Escolha outro quadrado!");
    }
  ...
  function jogada22() {
    if (quadrado9.style.backgroundColor == "yellow" || quadrado9.style.backgroundColor == "blue") {
      alert("Escolha outro quadrado!");
    }
...
for (let index = 0; index < 9; index++) {
  let quadra = document.getElementsByTagName('button')[index]
  if(quadra.style.backgroundColor == 'blue' || quadra.style.backgroundColor == 'yellow'){
    preenchido++
  }
}
 if(preenchido == 9 && vitoria() != 0 && vitoria() != 1){
